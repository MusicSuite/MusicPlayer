...
class DefaultApi {
  ...
  Future<Response<JsonObject>> addQueueAddPost({
    required Song song,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> addSongsAddPost({
    required Song song,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<JsonObject>> nextTrackPlayerActionsNextTrackGet({
    ...
    final _path = r'/player/actions/next_track';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<JsonObject>> pausePlayerActionsPauseGet({
    ...
    final _path = r'/player/actions/pause';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Song>> peekQueuePeekGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<JsonObject>> playPlayerActionsPlayGet({
    ...
    final _path = r'/player/actions/play';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Song] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Song>> playingPlayerPlayingGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<BuiltList<Song>>> queueQueueGet({
    ...
    return Response<BuiltList<Song>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> shuffleQueueShuffleGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<JsonObject>> stopPlayerActionsStopGet({
    ...
    final _path = r'/player/actions/stop';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
